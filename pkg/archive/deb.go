...
func NewDebArchive2(a *NewArchive, mp string) Interface {
	if a == nil {
		panic("nil archive supplied")
	}
...
func (d *debArchive2) Package(client *dagger.Client, c *dagger.Container, project *build.Spec) *dagger.Directory {
...
func (d *debArchive2) moveStaticFiles(c *dagger.Container, rootdir string) *dagger.Container {
...
func (d *debArchive2) withInstallScripts(c *dagger.Container) (*dagger.Container, []string) {
	newArgs := []string{}
...
func (d *debArchive2) installScript(script *InstallScript2, c *dagger.Container) (*dagger.Container, []string) {
	newArgs := []string{}
...
func (d *debArchive2) withControlFile(c *dagger.Container, version string, project *build.Spec) *dagger.Container {
	t := ControlTemplate
	...
	return c.
		...
		WithEnvVariable("_BINARIES", strings.Join(binaries, " ")).
		WithExec([]string{
			"bash", "-exuc", `
        : ${PROJECT_NAME}
        : ${VERSION}
...
func (d *debArchive2) systemdArgs() []string {
	args := []string{}
