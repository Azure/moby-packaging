...
func NewRPMArchive2(a *NewArchive, mp string) Interface {
	if a == nil {
		panic("nil archive supplied")
	}
...
func (r *rpmArchive2) Package(client *dagger.Client, c *dagger.Container, project *build.Spec) *dagger.Directory {
	dir := client.Directory()
	rootDir := "/package"
	...
	fpmArgs := []string{"fpm",
		...
		"--rpm-dist", rpmDistroMap[project.Distro],
		"--architecture", strings.Replace(project.Arch, "/", "", -1),
		"--description", string(r.a.Description),
		"--url", string(r.a.Webpage),
	}
...
func (r *rpmArchive2) withInstallScripts(c *dagger.Container) (*dagger.Container, []string) {
	newArgs := []string{}
...
func (r *rpmArchive2) installScript(script *InstallScript2, c *dagger.Container) (*dagger.Container, []string) {
	newArgs := []string{}
...
func (r *rpmArchive2) moveStaticFiles(c *dagger.Container, rootdir string) *dagger.Container {
	files := r.a.Files
	for i := range r.a.Systemd {
		sd := r.a.Systemd[i]
		files = append(files, File{
