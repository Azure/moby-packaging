...
var (
	...
	Archive  = archive.Archive{
		...
		Files: []archive.File{
			...
			{Source: "src/contrib/nuke-graph-directory.sh", Dest: "/usr/share/moby-engine/contrib/nuke-graph-directory.sh"},
			{Source: "src/contrib/check-config.sh", Dest: "/usr/share/moby-engine/contrib/check-config.sh"},
			{Source: "bundles/dynbinary-daemon/dockerd", Dest: "/usr/bin/dockerd"},
			{Source: "src/libnetwork/docker-proxy", Dest: "/usr/bin/docker-proxy"},
			{Source: "src/contrib/udev/80-docker.rules", Dest: "/lib/udev/rules.d/80-moby-engine.rules"},
			{Source: "", Dest: "/etc/docker", IsDir: true},
			{Source: "debian/legal/LICENSE", Dest: "/usr/share/doc/moby-engine/LICENSE"},
			{Source: "debian/legal/NOTICE", Dest: "/usr/share/doc/moby-engine/NOTICE.gz", Compress: true},
		},
