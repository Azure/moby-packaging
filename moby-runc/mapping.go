...
var (
	Archive = archive.Archive{
		...
		Files: []archive.File{
			{Source: "src/runc", Dest: "/usr/bin/runc"},
			{Source: "src/contrib/completions/bash/runc", Dest: "/usr/share/bash-completion/completions/runc"},
			{Source: "man", Dest: "/usr/share/man", IsDir: true, Compress: true},
			{Source: "debian/legal/LICENSE", Dest: "/usr/share/doc/moby-runc/LICENSE"},
			{Source: "debian/legal/NOTICE", Dest: "/usr/share/doc/moby-runc/NOTICE.gz", Compress: true},
		},
